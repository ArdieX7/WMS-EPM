...
class OperationType:
    ...
    CARICO_TEMPO_REALE = "CARICO_TEMPO_REALE"
    SCARICO_TEMPO_REALE = "SCARICO_TEMPO_REALE"
    SPOSTAMENTO_TEMPO_REALE = "SPOSTAMENTO_TEMPO_REALE"
    SCARICO_CONTAINER_TEMPO_REALE = "SCARICO_CONTAINER_TEMPO_REALE"
    UBICAZIONE_TERRA_TEMPO_REALE = "UBICAZIONE_TERRA_TEMPO_REALE"
    ...
    # Operazioni Arrivi
    ARRIVO_CREATO = "ARRIVO_CREATO"
    ARRIVO_MODIFICATO = "ARRIVO_MODIFICATO"
    ARRIVO_ELIMINATO = "ARRIVO_ELIMINATO"
    ARRIVO_CONFERMATO = "ARRIVO_CONFERMATO"
    CARICO_ARRIVO = "CARICO_ARRIVO"
    ARRIVO_SCAN_MOBILE = "ARRIVO_SCAN_MOBILE"
    ARRIVO_QUANTITY_MANUAL_UPDATE = "ARRIVO_QUANTITY_MANUAL_UPDATE"
    ARRIVO_CODE_UNEXPECTED_ADDED = "ARRIVO_CODE_UNEXPECTED_ADDED"
